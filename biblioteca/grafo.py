...
""" 
    Classe que implementa estrura de dados para grafos não direcionados utilizando lista de adjacência
"""

class Grafo:
    def __init__(self):
        self.lista_de_adjacencia = {} # inicializa o dicionário de adjacência do grafo
    ...
    """ 
        ...
        tem como parâmetro os vértices que a aresta conecta e o peso da aresta
    ...
    # método para conferir um caminho com um mínimo de quantidade de arestas
    def caminho(self, qtde_de_Arestas, T):
        visitados = set()
        caminho = []
        
        for vertice in self.lista_de_adjacencia.keys():
            if vertice not in visitados:
                ...
                while pai is not None:
                    caminho.append(pai)
                    pai = T[pai]
                if len(caminho) >= qtde_de_Arestas:
                    return caminho
                else:
                    caminho = []
